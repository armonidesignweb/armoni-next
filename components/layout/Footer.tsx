...
export default function Footer({ locale, settings }: FooterProps) {
  ...
  const address = settings?.address || tContact('addressValue');
  const phone = settings?.phone || tContact('phoneValue');
  const email = settings?.email || tContact('emailValue');
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 pb-16 border-b border-neutral-900">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <p className="text-sm text-neutral-400 font-light leading-relaxed max-w-sm">
                {settings?.footerText || t('description')}
              </p>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-sm font-light">
                <li className="flex items-start space-x-3 rtl:space-x-reverse">
                  ...
                  <span className="text-xs leading-relaxed whitespace-pre-wrap">{address}</span>
                </li>
